...
const Register = () => {
  ...
  return (
    <>
      <section className="text-gray-600 body-font relative bg-gradient-to-tl from-purple-500 to-indigo-400">
        <div className=" py-6 sm:py-8 lg:py-12">
          <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
            ...
            >
              <h2 className="text-gray-800 text-2xl lg:text-3xl font-bold text-center mt-4 md:mt-8">
                Register your new account
              </h2>
              <h2 className="text-gray-500 text-center my-3">
                Let's register to launch your dream.
              </h2>
              <div className="flex flex-col gap-4 p-4 md:p-8">
                ...
                <button className="block bg-gradient-to-tl from-indigo-500 to-purple-400 hover:bg-gray-700 active:bg-gray-600 focus-visible:ring ring-gray-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">
                  Register
                </button>
