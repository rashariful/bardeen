...
const Login = () => {
  ...
  return (
    <>
      <section className="text-gray-600 body-font relative bg-gradient-to-tl from-indigo-500 to-purple-400">
          ...
          <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
            ...
            >
              ...
              <div className="flex flex-col gap-4 p-4 md:p-8">
                ...
                <button className="block bg-gradient-to-tl from-purple-500 to-indigo-400 hover:bg-gray-700 active:bg-gray-600 focus-visible:ring ring-gray-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">
                  Log in
                </button>
