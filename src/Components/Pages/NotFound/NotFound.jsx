                ...
                <div className="max-w-screen-lg px-4 md:px-8 mx-auto">
                    <div className="grid sm:grid-cols-2 gap-8">
                        ...
                        <div className="h-80 md:h-auto bg-gray-100 overflow-hidden shadow-lg rounded-lg relative">
                            <img src="https://cdn.dribbble.com/users/19216/screenshots/2432035/media/4ab157e1e3ff38a867dec023e4127eed.png?compress=1&resize=400x300&vertical=top" loading="lazy" alt="Photo by @heydevn" className="w-full h-full object-cover object-center absolute inset-0" />
                        </div>
                        {/* <!-- image - end --> */}
                    </div>
                </div>
